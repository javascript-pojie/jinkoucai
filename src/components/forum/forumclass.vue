    ...
    <div class="container">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                ...
                <router-link to="/forumclass/add"><el-button style="float: right; padding: 3px 0" type="text">添加新的分类</el-button></router-link>
            </div>
            <el-table
                    :data="tableData"
                    style="width: 100%">
...
<script>
    export default {
        ...
        methods:{
            getData(){
                this.post('/edu-admin/tag/list',{curpage:1}).then(r=>{
                    if(r.data.code === 1){
            ...
            onDelete(i,r){
                this.post('/edu-admin/tag/delete',{ids:[r.id]}).then(r=>{
                    if(r.data.code === 1){
